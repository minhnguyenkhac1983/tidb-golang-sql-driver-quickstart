# 如何用 go-sql-driver/mysql 连接到 TiDB
...
这是 PingCAP 为 go-sql-driver/mysql 编写的用于连接 TiDB 的示例项目

> TiDB 是一个兼容 MySQL 的数据库。[go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) 是 [database/sql](https://pkg.go.dev/database/sql) 接口的 MySQL 实现。
...
关于 **go-sql-driver/mysql** 的更多使用方法及细节，可以参考 [go-sql-driver/mysql 官方文档](https://github.com/go-sql-driver/mysql/blob/master/README.md)。
